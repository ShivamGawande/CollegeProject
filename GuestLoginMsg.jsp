...
<body>
   <header>
    ...
    <h1><b>Dear user if you want to access our different feature,for that you have to Login to unlock full website if you are not registered then you have register yourself <br>
                        <a href="login.html">Click here for existing user </a><br>
                        <a href="signup.html"> Click here for new user</a> </b></h1>
